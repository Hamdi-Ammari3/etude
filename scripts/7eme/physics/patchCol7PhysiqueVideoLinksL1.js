// scripts/patchCol7PhysiqueVideoLinksL1.js
...
const VIDEO_LINKS = {
  l1: [
    {
      title: "سابعة أساسي — علوم فيزيائية: الحالات الفيزيائية للمادة، خصائصها وتحولاتها (درس + تمرين)",
      channel: "الأستاذة جيهان الماي",
